...
<div className={Styles.info}>
    ...
    <p className={Styles.poctext}>As a dancer or enthusiast, have you ever found yourself out of ideas for new choreography? Say no more! With AI, the possibilities of creativity are endless. We proudly present Nataraj AI, a platform to revolutionize dance creativity.
...
<div className={Styles.faqs}>
    ...
    <h4 className={Styles.question}>Does Nataraj use AI?</h4>
      <p className={Styles.answer}>Yes, AI is at the core of Nataraj, and Gemini APIs help us achieve our deliverables.</p>
      <h4 className={Styles.question}>Is it free to use?</h4>
      <p className={Styles.answer}>Upto 3 projects, yes. More than that, please contact us.</p>
      <h4 className={Styles.question}>Is your personal data like dance video saved?</h4>
      <p className={Styles.answer}>No, we don't save your personal media data, it remains on your local storage of mobile.</p>
      <h4 className={Styles.question}>Can you request your user data to be deleted?</h4>
      <p className={Styles.answer}>All the user data is deleted once the user asks for the deletion of their account.</p>
    </div>
</div>
